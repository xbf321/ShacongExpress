...
namespace ShacongExpress.Common
{
    ...
    public class Utils
    {
        ...
        public static string GetPageNumbers(int curPage, int countPage, string url) {
            return GetPageNumbers(curPage,countPage,url,10);
        }
        /// <summary>
        /// 获得页码显示链接
        /// </summary>
        ...
        public static string GetPageNumbers(int curPage, int countPage, string url, int extendPage, string pagetag, string anchor)
        {
            ...
            StringBuilder s = new StringBuilder("<div id=\"pager\">");
        ...
        */
        ...
        public static TimeSpan StrToTimeSpan(string expression) {
            TimeSpan t = new TimeSpan(0);
            bool isTimespan = TimeSpan.TryParse(expression,out t);
            return t;
        }
